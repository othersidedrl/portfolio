...
import { MessageSquarePlus, Rocket, ShieldCheck, Sparkles, Zap } from "lucide-react";
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-[var(--text-muted)] font-medium">
          Elevate your digital presence with premium exclusive features.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="relative overflow-hidden border-2 border-[var(--color-primary)] shadow-xl shadow-[var(--color-primary)]/10">
          <div className="absolute top-0 right-0 p-3">
            <span className="px-2 py-1 rounded-lg bg-[var(--color-primary)] text-[8px] font-black uppercase tracking-widest text-[var(--color-on-primary)] shadow-lg animate-pulse">
              Pro
            </span>
          </div>
          <CardHeader>
            ...
            <CardDescription>
              Automatically refine your bio and project descriptions using advanced LLMs.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="shadow-lg hover:border-[var(--color-primary)]/20 transition-all group">
          <CardHeader>
            ...
            <CardDescription>
              Optimize your page metadata and social graph for maximum reach.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-4">
        ...
        <Card className="shadow-lg hover:border-[var(--color-primary)]/20 transition-all group">
          <CardHeader>
            ...
            <CardDescription>
              Scan your portfolio links and assets for broken references and vulnerabilities.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-4">
            <Button variant="secondary" className="w-full font-bold">
      ...
      <div className="rounded-3xl p-12 bg-gradient-to-br from-[var(--bg-mid)] to-[var(--bg-dark)] border border-[var(--border-color)] text-center space-y-6 relative overflow-hidden">
        ...
        <div className="max-w-xl mx-auto space-y-4">
          ...
          <p className="text-sm text-[var(--text-muted)] font-medium leading-relaxed italic">
            Portfolio+ is expandable. If you need a custom tool for your management workflow, let me
            know and I'll build it for you.
          </p>
        </div>
        <Button
          variant="secondary"
