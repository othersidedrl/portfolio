...
const TechnicalSkillsCard: FC<TechnicalSkillsCardProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`flex w-full flex-wrap items-center gap-2 text-[var(--text)] ${
        ...
        >
          ...
          >
            {stats && stats.length > 0 && (
              <div className="flex w-full justify-around gap-6 text-[var(--text)]">
                {stats.map((stat) => (
                  <div
                    key={stat.label}
            ...
            {specialities && specialities.length > 0 && (
              <div className="flex w-full flex-col gap-3">
                <hr className="w-full border-t border-[var(--border-soft)]" />
