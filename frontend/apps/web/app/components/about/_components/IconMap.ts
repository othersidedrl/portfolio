...
export const iconMap: { keywords: string[]; icon: LucideIcon }[] = [
  ...
  { keywords: ["node", "nodejs", "express", "fastify", "nest", "hapi", "koa", "pm2"], icon: Server },
  { keywords: ["python", "py", "flask", "django", "fastapi", "pytorch", "tensorflow", "numpy", "scipy"], icon: Terminal },
  ...
  { keywords: ["react", "next", "preact", "vite", "solid", "svelte", "remix", "astro"], icon: Atom },
  { keywords: ["typescript", "ts", "javascript", "js", "es6", "babel", "webpack", "rollup"], icon: Code2 },
  { keywords: ["frontend", "ui", "ux", "css", "scss", "sass", "tailwind", "bootstrap", "material-ui", "chakra"], icon: Layout },

  // Mobile
  { keywords: ["react-native", "native", "flutter", "dart", "android", "ios", "swift", "kotlin"], icon: Smartphone },
  ...
  { keywords: ["backend", "api", "rest", "graphql", "graphql-api", "grpc", "microservice", "microservices"], icon: Globe },
  { keywords: ["server", "serverless", "edge"], icon: Server },

  // DevOps / CI-CD / version control
  { keywords: ["ci", "cd", "github-actions", "jenkins", "gitlab-ci", "circleci", "travis"], icon: GitBranch },
  { keywords: ["git", "github", "gitlab", "version-control", "commit", "branch"], icon: GitBranch },

  // Messaging & streaming
  { keywords: ["kafka", "rabbitmq", "nats", "mqtt", "activemq", "pubsub", "streaming", "message"], icon: MessageSquare },

  // Monitoring / observability / logging
  { keywords: ["prometheus", "grafana", "loki", "sentry", "datadog", "newrelic", "observability", "otel", "opentelemetry"], icon: Monitor },

  // Security / auth
  { keywords: ["oauth", "jwt", "openid", "sso", "auth0", "keycloak", "passport", "authentication", "authorization"], icon: ShieldCheck },
  { keywords: ["encryption", "tls", "ssl", "cert", "key", "secrets"], icon: Key },
  { keywords: ["acl", "rbac", "permissions"], icon: Lock },

  // Testing / quality
  { keywords: ["jest", "mocha", "chai", "pytest", "cypress", "playwright", "testing", "tdd", "bdd"], icon: Zap },

  // Data / analytics / ETL
  { keywords: ["spark", "hadoop", "airflow", "dag", "dbt", "pandas", "etl", "data", "analytics"], icon: BarChart },

  // Payments & commerce
  { keywords: ["stripe", "paypal", "payment", "billing", "checkout", "midtrans"], icon: CreditCard },
