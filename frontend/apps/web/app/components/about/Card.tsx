...
const Card: FC<CardProps> = ({ title = "2+", description = "Years of Experience" }) => {
  return (
    <div className="group relative flex w-full flex-col items-center justify-center rounded-3xl border border-[var(--border-color)] bg-[var(--bg-mid)]/40 p-6 text-center transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] hover:-translate-y-2 hover:border-[var(--color-primary)]/50 hover:bg-[var(--bg-mid)]/80 hover:shadow-[0_20px_40px_rgba(0,0,0,0.1)] backdrop-blur-sm overflow-hidden">
