          ...
          <ul className="flex flex-col gap-2 pb-2">
            {navItems.map((text, i) => (
              <li
                ...
                className={`px-4 py-3 rounded-xl hover:bg-[var(--color-primary)]/10 hover:text-[var(--color-primary)] font-bold text-sm uppercase tracking-widest transition-all duration-300 cursor-pointer ${
