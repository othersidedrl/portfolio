  ...
  return (
    <div className="flex flex-col text-[var(--text)] font-poppins relative">
      ...
      <div className="flex items-center gap-2 mb-6 animate-in fade-in duration-1000">
        <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-[var(--bg-mid)] border border-[var(--border-color)] shadow-sm">
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
          </span>
          <span className="text-[10px] uppercase tracking-widest font-bold text-[var(--text-muted)]">Available for work</span>
        </div>
      </div>
